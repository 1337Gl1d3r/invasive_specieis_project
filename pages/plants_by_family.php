  ...
  <body background="../images/background.jpeg">
    ...
    <?php
      ...
      //
        ...
        echo '<div class="jumbotron">';
        echo '<div align="center">';        
        echo "<h2><bold>Search by Family</bold></h2>";
        echo "<br><br>";
        echo "<form "."name="."colourpick"." "."method="."post1".">";
          echo "<select name="."colours".">";
            echo "<option value="."select".">Select...</option>";
            echo "<option value="."Knapweeds".">Knapweeds</option>";
            echo "<option value="."Burdocks".">Burdocks</option>";
            echo "<option value="."Thistles".">Thistles</option>";
            echo "<option value="."Hawkweeds".">Hawkweeds</option>";
          echo "</select>";
          echo "<br><br>";
        ...
        {
          $input = mysqli_real_escape_string($conn, $_REQUEST['colours']);
          if($input)
          {
            $sql1 = "SELECT `e_plants`.*, `r_member_of`.*, `e_invasive_species`.*\n"

                . "FROM `e_plants`\n"

                . "    LEFT JOIN `e_invasive_species` ON `e_invasive_species`.`inv_sci_name` = `e_plants`.`inv_sci_name`\n"
                
                . "    LEFT JOIN `r_member_of` ON `r_member_of`.`inv_sci_name` = `e_plants`.`inv_sci_name`\n"
                
                . "    WHERE `r_member_of`.`family_name` ='$input'";              

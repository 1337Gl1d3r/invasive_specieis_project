  ...
  <body background="../images/background.jpeg">
    ...
    <?php
      ...
      //
        ...
        echo '<div align="center">';
        echo '<div class="jumbotron">';
        echo "<h2><bold>Search by Flower Colour</bold></h2>";
        echo "<br><br>";
        ...
        if (isset($_REQUEST['colours']))
        {
          ...
          if($input)
          {
            $sql1 = "SELECT `e_plants`.*, `m_flower_colour`.*, `e_invasive_species`.*\n"

                . "FROM `e_plants`\n"

                . "    LEFT JOIN `e_invasive_species` ON `e_invasive_species`.`inv_sci_name` = `e_plants`.`inv_sci_name`\n"
                
                . "    LEFT JOIN `m_flower_colour` ON `m_flower_colour`.`inv_sci_name` = `e_plants`.`inv_sci_name`\n"
                
                . "    WHERE `m_flower_colour`.`color` ='$input'";              
